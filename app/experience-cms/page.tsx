                        ...
                        <div className="flex flex-col md:flex-row gap-y-2 items-start md:items-center justify-between mb-6">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                                    {selectedRoom ? "Edit Experience" : "Add New Experience"}
                                </h1>
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="flex flex-col md:flex-row gap-y-2 items-start md:items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Manage your experience&apos;s inventory and details</p>
                    </div>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    <TabsList>
                        ...
                        <TabsTrigger value="rooms">All Experiences</TabsTrigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <Card>
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Active Experiences</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Booking rates and revenue by experience</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
